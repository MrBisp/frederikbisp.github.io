const projects = [
    ...
    },
    {
        ...
        embed: "<div class=\"project-image-carousel\" ><img class='project-image active' src='img/employee-match-2.png' alt='Project-Employee matching' data-index=\"0\" /><img class='project-image' src='img/employee-match-1.png' alt='Project-Employee matching' data-index=\"1\" /><img class='project-image' src='img/employee-match-3.png' alt='Project-Employee matching' data-index=\"2\" /><img class='project-image' src='img/employee-match-4.png' alt='Project-Employee matching' data-index=\"3\" /></div>"
    },
    {
        name: "Hungry Homies",
